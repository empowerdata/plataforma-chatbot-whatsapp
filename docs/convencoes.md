...
- `numbers.ts` (todo número tem cliente: `clientId` obrigatório): listNumbers, getNumber, createNumber, getConnectionInfo, reconnectNumber, disconnectNumber, deleteNumber, updateNumber, assignBot. Rota de polling: `GET /api/numeros/[id]/conexao?refresh=1`.
